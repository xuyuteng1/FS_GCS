    ...
    : QGeoTiledMappingManagerEngine()
{
    ...
    if (parameters.contains(QStringLiteral("cachefolder")))
        m_cacheDirectory = parameters.value(QStringLiteral("cachefolder")).toString();
    ...
    if (m_cacheDirectory.isEmpty())
        ...
        m_cacheDirectory = QCoreApplication::applicationDirPath()+ QLatin1String("/MapCache/googlemaps");
