...
protected:
    ...
    void drawPointerCircleBase(QPainter *painter);
...
private:
    double minXValue = -100;               /*X轴最小值*/
    double maxXValue = 100;               /*X轴最大值*/
    double minYValue = -100;               /*Y轴最小值*/
    double maxYValue = 100;               /*Y轴最大值*/
    double xValue = -0;                      /*X轴当前值*/
    double yValue = 0;                  /*Y轴当前值*/
...
public:
    ...
    void setMinXValue(double newMinXValue);

    double getMaxXValue() const;
    void setMaxXValue(double newMaxXValue);
...
Q_SIGNALS:
    ...
    void valueChangedSignal(int x,int y);
};
