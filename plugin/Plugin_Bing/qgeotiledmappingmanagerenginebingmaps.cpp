    ...
    : QGeoTiledMappingManagerEngine()
{
    ...
    if (parameters.contains(QStringLiteral("cachefolder")))
        m_cacheDirectory = QAbstractGeoTileCache::baseCacheDirectory()+ parameters.value(QStringLiteral("cachefolder")).toString().toLatin1();
    else
        m_cacheDirectory = QCoreApplication::applicationDirPath()+ QLatin1String("/MapCache/bingmaps");
