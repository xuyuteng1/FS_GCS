...
//    font.setItalic(true);//设置斜体
//    font.setBold(false);//设置加粗
    painter->setFont(QFont(QStringLiteral("宋体"), 45, QFont::Thin, false));
...
{
    setBgColor(QColor(15, 185, 112));
}

void LightButton::setRed()
{
    setBgColor(QColor(239, 87, 103));
}

void LightButton::setYellow()
{
    setBgColor(QColor(255,230,71));
}
