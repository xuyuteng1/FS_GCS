#ifndef GIS_AIRPOINTMODEL_H
#define GIS_AIRPOINTMODEL_H
#include <QAbstractItemModel>
#include <QGeoCoordinate>
#include <QDebug>

class GIS_AirPointModel : public QAbstractItemModel
{
    Q_OBJECT
...
public slots:
    void update_Waypoint(double lat, double lng, float alt, int _radius, bool visable);
signals:
    void dataChanged();
};

#endif // GIS_AIRPOINTMODEL_H
