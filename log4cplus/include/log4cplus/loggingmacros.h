...
#endif
#if !defined(LOG4CPLUS_DISABLE_CMD)
#define LOG4CPLUS_CMD(logger, logEvent) \
if(logger.isEnabledFor(CMD_LOG_LEVEL)) { \
    log4cplus::tostringstream _log4cplus_buf; \
    _log4cplus_buf << logEvent; \
    logger.forcedLog(CMD_LOG_LEVEL, _log4cplus_buf.str(), __FILE__, __LINE__); \
}
#endif
/**
